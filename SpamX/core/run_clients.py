...
def start_spamX(Devil, type):
  ...
  if type == "token":
    ...
    try: 
      ...
      print(f"DeviGdha - [INFO]: @{x.username} started ✓")

    
    
    except: 

        print(f"DevilGdha - [INFO]: Bot started ✓") 
    ...
    try:
      ...
      print(f"DevilGdha - [INFO]: @{x.first_name} started ✓")

    except: 

      print(f"Devil Gdha - [INFO]: Client started ✓")
...
def Run_SpamX():
    ...
    print(""" \n\n
     ╒═══════════════════════════╕
      ...
      Visit @SaNkiFigHter1 for updates!
     ╘═══════════════════════════╛
    """)
    idle()
