...
async def SpamX_(SpamX: Client, message: Message):
    ...
    spamx_reply = "**__SaNkiFigHter by Devilking;__** \n\n"
    spamx_reply += "<=======================> \n"
    ...
    spamx_reply += "<=======================> \n\n"
    spamx_reply += "**Source Code:** [GitHub 🐈‍⬛](https://te.legra.ph/file/1facd8b18af633fa20eaa.mp4) \n\n"
    spamx_reply += "**© @SaNkiFigHter1** || Support: @SaNkiFigHter1"
